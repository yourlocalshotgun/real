...
local library = {
    version = "2.0.2",
    title = title or "pixel " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Introduction()
    ...
    local barCorner = Instance.new("UICorner")
    local barLayout = Instance.new("UIListLayout")
    local pixelLogo = Instance.new("ImageLabel")
    ...
    pixelLogo.Name = "pixelLogo"
    pixelLogo.Parent = background
    pixelLogo.AnchorPoint = Vector2.new(0.5, 0.5)
    pixelLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    pixelLogo.BackgroundTransparency = 1.000
    pixelLogo.Position = UDim2.new(0.5, 0, 0.5, 0)
    pixelLogo.Size = UDim2.new(0, 448, 0, 150)
    pixelLogo.Visible = true
    pixelLogo.Image = "http://www.roblox.com/asset/?id=9365068051"
    pixelLogo.ImageColor3 = Color3.fromRGB(159, 115, 255)
    pixelLogo.ImageTransparency = 1
    ...
    pixel.BackgroundTransparency = 1.000
    pixel.Size = UDim2.new(0, 80, 0, 21)
    pixel.Font = Enum.Font.Code
    pixel.Text = "powered by pixel"
    pixel.TextColor3 = Color3.fromRGB(124, 124, 124)
    pixel.TextSize = 10.000
    pixel.TextTransparency = 1
    ...
    CreateTween("pixelRotation", 0)
    local MinusAmount = -16
    coroutine.wrap(function()
        while wait() do
            MinusAmount = MinusAmount + 0.4
            TweenService:Create(pixelLogo, TweenTable["pixelRotation"], {Rotation = pixelLogo.Rotation - MinusAmount}):Play()
        end
    end)()
    ...
    wait(.2)
    TweenService:Create(pixel, TweenTable["introduction"], {TextTransparency = 0}):Play()
    TweenService:Create(text, TweenTable["introduction"], {TextTransparency = 0}):Play()
    wait(.3)
    TweenService:Create(pixelLogo, TweenTable["introduction"], {ImageTransparency = 0}):Play()
    wait(2)
    TweenService:Create(pixelLogo, TweenTable["introduction"], {ImageTransparency = 1}):Play()
    wait(.2)
    ...
    wait(.1)
    TweenService:Create(pixel, TweenTable["introduction"], {TextTransparency = 1}):Play()
    wait(.1)
